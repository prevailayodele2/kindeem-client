              ...
              <Col lg={24}>
                {
                  productDetails?.product.name && (
                    <Breadcrumb>
                      <Breadcrumb.Item><Link legacyBehavior href="/"><a>Home</a></Link></Breadcrumb.Item>
                      {
                        productDetails?.product.category[0].parent &&
                        <Breadcrumb.Item>
                          <Link legacyBehavior href={`/category/${productDetails.product.category[0].parent.slug}/${productDetails.product.category[0].parent._id}`}><a>{productDetails.product.category[0].parent.displayName}</a></Link>
                        </Breadcrumb.Item>
                      }
                      {
                        productDetails?.product.category[0].parent &&
