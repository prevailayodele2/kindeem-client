              ...
              <div className="reviews">
                {!checkSkeleton && (
                  <span>
                    ...
                    {this.props.products?.productQA?.totalCount} FAQ answered
                  </span>
                )}
              </div>
            </div>
                    ...
                    <>
                      ...
                      <Button
                        disabled={
                          ...
                          this.state.disableBuyNow ||
                          this.props.products.productDetailsLoading
                        }
                        className="primary"
                        onClick={() => this.addToCart(product.slug)}
                      >
                        {this.props.cart.loading && (
